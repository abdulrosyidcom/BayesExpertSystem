                ...
                <div class="card-body">
                    <div class="row row-xs">
                        <div class="col-md-12">
                            ...
                            <textarea name="content" id="ckeditor" class="form-control ckeditor">{{ $post->content }}</textarea>
                        </div>
                    </div>
                </div>
            </div>
                ...
                <div class="card-body">
                    <div class="row row-xs">
                        ...
                        <div class="col-md-12 mt-2">
                            <img src="{{ asset('storage/posts/' . $post->image) }}" id="output" class="img-thumbnail" style="width : 100%">
                        </div>
                        ...
                        <div class="col-md-12">
                            <div class="form-group">
                                <div class="custom-control custom-checkbox sb-custom-control-solid">
                                    <input class="custom-control-input" id="status" name="status" type="checkbox" {{ $post->status == true ? 'checked' : '' }} />
